...
dpo_loss_config.nondominate_punishment=prob_diff dpo_loss_config.epsilon=0.1 \
training_device='cuda' max_train_steps=12000 project_name=tst-task run_name=tst-dpo-multi-prdif-gpt2-xl-0.1lr \
