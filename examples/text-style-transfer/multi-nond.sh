...
dpo_loss_config.name=ipo dpo_loss_config.dpo_training=true dpo_loss_config.multi_optimize=true \
dpo_loss_config.nondominate_punishment=null dpo_loss_config.epsilon=1 \
training_device='cuda' max_train_steps=8000 project_name=tst-task run_name=tst-multi_nond_ipo \
eval_steps=1000 dominate_evaluate_num=64 \
target_update_method="polyak" target_learning_rate=0.1 \
model_path=$model_path load_step=4000 
# max_size=16
