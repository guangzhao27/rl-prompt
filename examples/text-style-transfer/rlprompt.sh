...
dpo_loss_config.name=ipo dpo_loss_config.dpo_training=false dpo_loss_config.multi_optimize=false reward_type=rlprompt \
dpo_loss_config.nondominate_punishment=null dpo_loss_config.epsilon=1 \
training_device='cuda' max_train_steps=6000 project_name=tst-task run_name=tst-rlprompt \
