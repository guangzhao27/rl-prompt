...
dpo_loss_config.name=reinforce dpo_loss_config.dpo_training=true dpo_loss_config.multi_optimize=false \
dpo_loss_config.nondominate_punishment=null dpo_loss_config.epsilon=1 \
training_device='cuda' max_train_steps=4000 project_name=tst-task run_name=tst-rlprompt-gpt2-xl-0.1lr \
