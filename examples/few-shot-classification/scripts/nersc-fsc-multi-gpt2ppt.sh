...
training_device='cuda' max_train_steps=6000 project_name=fsc-iclr run_name=$dataset-$run_name-$algorithm_name \
dominate_evaluate_num=64 \
target_update_method="copy" target_update_steps=200 \
algorithm_name=$algorithm_name use_perplexity=true
